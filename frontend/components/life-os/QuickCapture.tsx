  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 md:bottom-8 right-6 w-14 h-14 bg-[var(--md-primary)] rounded-2xl shadow-2xl shadow-blue-500/25 flex items-center justify-center hover:scale-105 transition-all z-40 glass-shine"
      >
