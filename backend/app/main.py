...
# ── Routers ─────────────────────────────────────────────────────────────────
from app.api.v1 import users, entries, goals, habits, domains, social, notifications, ai_coach, personalisation, mcp, tasks, planner, homescreen, documents, finance, health_data, privacy, assets, vault, important_dates, knowledge, life
...
app.include_router(important_dates.router, prefix="/api/v1")
app.include_router(knowledge.router, prefix="/api/v1")
app.include_router(life.router, prefix="/api/v1")
